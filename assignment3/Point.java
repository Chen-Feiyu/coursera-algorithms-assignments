...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        ...
        if (this.x == that.x && this.y == that.y) 
            return Double.NEGATIVE_INFINITY; // identical point
    ...
    public static void main(String[] args) {
        ...
        Point t = new Point(3, 5);
        System.out.println(p.toString());
        System.out.println(p.slopeTo(q) == 3.0);
        System.out.println(p.slopeTo(r) == Double.POSITIVE_INFINITY);
        System.out.println(p.slopeTo(t) == 0.0);
        System.out.println(p.slopeTo(p) == Double.NEGATIVE_INFINITY);
        System.out.println(p.slopeOrder().compare(q, t) == 1);
